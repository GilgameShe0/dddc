...
<body>
	<div class="hotel_info">
		<div class="hotel_name"><?php echo $order_info['hotel_name'];?></div>
		<div class="order_date">
			<span class="live_date"><?php echo $order_info['startDate']." 到 ".$order_info['endDate']?></span>丨 
			<span class="sort_time">共<?php echo $order_info['NumDate']?>晚</span>
		</div>
		<div class="room_info">
			<span class="room_name"><?php echo $order_info['roomtype']?></span>
			<span class="breakfast">双早</span>
			<span class="windows">有窗</span>
		</div>
	</div>
	...
	<div class="hotel_agreement">
		<label class="checkbox">
			<input type="checkbox" id="checkbox-id">同意酒店信用入住相关协议
		</label>
	</div>
	<div class="order-submit">
	    <div class="order-submit-fixed">
	        <p class="order-submit-c1">实际应付款: <span class="text-important">¥<?php echo $order_info['roomprice']*$order_info['NumDate']?></span></p>
